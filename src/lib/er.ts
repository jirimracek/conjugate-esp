 ...
 * @license * MIT License
*/
import { ModelInterface, RegionType, V2M_PronType, NONPRONOMINAL, V2M_AttrType, TERM, ER } from './interfaces';
import { Model } from './model';
import { esdrujula, dropAccents } from './tools';

export class Temer extends Model implements ModelInterface {
