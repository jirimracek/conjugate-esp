...
export abstract class BaseModel {
  ...
  protected setIndicativoPresente(roots?: string[]): void {
      ...
      // The .trim() is needed for case of missing pronouns (some defectives)
      this.desinences.Indicativo.Presente.map((desinence, index) => 
  ...
  protected setIndicativoPreteritoImperfecto(roots?: string[]): void {
      this.table.Indicativo.PreteritoImperfecto =
      this.desinences.Indicativo.PreteritoImperfecto.map((desinence, index) => 
          `${this.pronouns[this.type][this.region][index]} ${roots ?
              roots[index] :
              this.stem}${desinence}`.trim());
  }
  protected setIndicativoPreteritoIndefinido(roots?: string[]): void {
      this.table.Indicativo.PreteritoIndefinido =
      this.desinences.Indicativo.PreteritoIndefinido.map((desinence, index) => 
          `${this.pronouns[this.type][this.region][index]} ${roots ?
              roots[index] :
              this.stem}${desinence}`.trim());
  }
  protected setIndicativoFuturoImperfecto(roots?: string[]): void {
      this.table.Indicativo.FuturoImperfecto =
      this.desinences.Indicativo.FuturoImperfecto.map((desinence, index) => 
          `${this.pronouns[this.type][this.region][index]} ${roots ?
              roots[index] :
              this.stem}${desinence}`.trim());
  }
  protected setIndicativoCondicionalSimple(roots?: string[]): void {
      this.table.Indicativo.CondicionalSimple =
      this.desinences.Indicativo.CondicionalSimple.map((desinence, index) => 
          `${this.pronouns[this.type][this.region][index]} ${roots ?
              roots[index] :
              this.stem}${desinence}`.trim());
  }
  ...
  protected setSubjuntivoPresente(roots?: string[]): void {
      ...
      this.desinences.Subjuntivo.Presente.map((desinence, index) => 
          `${this.pronouns[this.type][this.region][index]} ${roots ?
              roots[index] :
              this.stem}${desinence}`.trim());
  }
  ...
  protected setSubjuntivoPreteritoImperfectoRa(roots?: string[]): void {
      this.table.Subjuntivo.PreteritoImperfectoRa =
      this.desinences.Subjuntivo.PreteritoImperfectoRa.map((desinence, index) => 
          `${this.pronouns[this.type][this.region][index]} ${roots ?
              roots[index] :
              this.stem}${desinence}`.trim());
  }
  ...
  protected setSubjuntivoPreteritoImperfectoSe(roots?: string[]): void {
      this.table.Subjuntivo.PreteritoImperfectoSe =
      this.desinences.Subjuntivo.PreteritoImperfectoSe.map((desinence, index) => 
          `${this.pronouns[this.type][this.region][index]} ${roots ?
              roots[index] :
              this.stem}${desinence}`.trim());
  }
  ...
  protected setSubjuntivoFuturoImperfecto(roots?: string[]): void {
      this.table.Subjuntivo.FuturoImperfecto =
      this.desinences.Subjuntivo.FuturoImperfecto.map((desinence, index) => 
          `${this.pronouns[this.type][this.region][index]} ${roots ?
              roots[index] :
              this.stem}${desinence}`.trim());
  }
