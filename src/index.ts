...
* find them useful and import them from lib/basemodel
* export { INDICATIVO_SIMPLE_KEYS, INDICATIVO_COMP_KEYS, SUBJUNTIVO_SIMPLE_KEYS, SUBJUNTIVO_COMP_KEYS, IMPERATIVO_KEYS } from './lib/basemodel';
*/
